...
一套覆盖前端开发、移动端、图形渲染、多模态生成、文档处理、代码审查与系统重构的智能技能集合。
...
| code-reviewer　　　　　　　| 资深 Python + Vue 全栈代码审计。发现 Bug / 性能 / 安全 / 架构问题，输出风险等级（P0/P1/P2）与修复建议。　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | Local　　 |
...
| minimax-multimodal-toolkit | 通过 MiniMax API 生成语音、音乐、视频和图片内容 — MiniMax 多模态使用场景的统一入口。涵盖 TTS（文字转语音、声音克隆）、音乐、视频（文生/图生/长视频多场景）、图片生成，以及基于 FFmpeg 的媒体处理。　　　　　　　　　　　　　　　　　　　　| Official　|
...
| minimax-xlsx　　　　　　　 | 打开、创建、读取、分析、编辑或验证 Excel/电子表格文件（.xlsx、.xlsm、.csv、.tsv）。支持通过 XML 模板从零创建、使用 pandas 读取分析、零格式损失编辑、公式重算与验证、专业财务格式化。　　　　　　　　　　　　　　　　　　　　　　　　　　　| Official　|
